 ...
 */
ImportHelpers.buildUpdateData = (newItem) => {
...
ImportHelpers.asyncForEach = async (array, callback) => {
    for (let index = 0; index < array.length; index += 1) {
        await callback(array[index], index, array);
    }
};
ImportHelpers.minionTemplate = {
    name: "no name",
    type: "minion",
    data: {
        biography: "",
...
ImportHelpers.characterTemplate = {
    name: "No Name",
    type: "character",
    flags: {},
    data: {
...
ImportHelpers.b64toBlob = (b64Data, contentType, sliceSize) => {
