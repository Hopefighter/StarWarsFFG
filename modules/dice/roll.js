...
export class RollFFG extends Roll {
    ...
    getTooltip() {
        const parts = this.dice.map((d) => {
            ...
            let isFFG = "notFFG";
            if (game.ffg.diceterms.includes(cls))
                isFFG = "isFFG";
            return {
                formula: d.formula,
                total: d.total,
...
RollFFG.CHAT_TEMPLATE = "systems/starwarsffg/templates/dice/roll-ffg.html";
RollFFG.TOOLTIP_TEMPLATE = "systems/starwarsffg/templates/dice/tooltip-ffg.html";
